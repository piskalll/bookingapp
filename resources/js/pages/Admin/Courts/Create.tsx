...
export default function CourtsCreate({ venues }: Props) {
        ...
        <>
            ...
            <div className="p-6 max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Tambah Lapangan</h1>
                    <p className="text-gray-600 mt-2">Tambahkan lapangan olahraga baru ke sistem</p>
                </div>
