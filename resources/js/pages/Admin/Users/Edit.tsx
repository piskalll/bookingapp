                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Ubah profil atau perbarui password untuk akun pengguna ini.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <div className="sm:col-span-2 p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl space-y-4">
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Kosongkan kedua kolom di bawah jika Anda tidak ingin mengubah password.</p>
                                </div>
